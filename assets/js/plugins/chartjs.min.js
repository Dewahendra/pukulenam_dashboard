!(function (t, e) {
      ...
      for (x = 0; x < c; ++x) {
        ...
        (b = Bi(e, x, r)),
          void 0 !== b &&
            ...
            d.push({ tx1: y, ty1: v, tx2: M, ty2: w, x1: k, y1: S, x2: P, y2: D, width: i, color: o, borderDash: a, borderDashOffset: c, tickWidth: h, tickColor: u, tickBorderDash: f, tickBorderDashOffset: g }));
      }
    ...
    _computeLabelItems(t) {
      ...
      for (p = 0, m = r.length; p < m; ++p) {
        ...
        a
          ...
          : ((y = M), (P = ((1 - S) * k) / 2)),
          g.push({ rotation: f, label: b, font: w, color: n, strokeColor: l, strokeWidth: h, textOffset: P, textAlign: v, textBaseline: D, translation: [_, y] });
      }
      return g;
    }
    ...
    drawGrid(t) {
      ...
      if (a) {
        const t = i.setContext(e.getContext(e._ticksLength - 1)),
          ...
          s = e._borderValue;
        let r, l, c, d;
        e.isHorizontal() ? ((r = Ut(o, e.left, a) - a / 2), (l = Ut(o, e.right, n) + n / 2), (c = d = s)) : ((c = Ut(o, e.top, a) - a / 2), (d = Ut(o, e.bottom, n) + n / 2), (r = l = s)),
  ...
  function rn(t) {
    ...
    !(function (t, e, i) {
      ...
      for (let h = 0; h < n - 1; ++h)
        (l = c),
          (c = sn(t, h + 1)),
          l && c && (Ot(e[h], 0, on) ? (i[h] = i[h + 1] = 0) : ((o = i[h] / e[h]), (s = i[h + 1] / e[h]), (r = Math.pow(o, 2) + Math.pow(s, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
    })(t, i, n),
      (function (t, e) {
        const i = t.length;
        let n,
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            (s = r),
            (r = i < n - 1 && Kt(t[i + 1], e)),
            s && ((o = t[i]), a && ((o.cp1x = ln(o.cp1x, e.left, e.right)), (o.cp1y = ln(o.cp1y, e.top, e.bottom))), r && ((o.cp2x = ln(o.cp2x, e.left, e.right)), (o.cp2y = ln(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function hn(t, e, i, n) {
  ...
  function mn(t) {
    return 'angle' === t ? { between: Wt, compare: Vt, normalize: Bt } : { between: (t, e, i) => t >= e && t <= i, compare: (t, e) => t - e, normalize: (t) => t };
  }
  function xn(t, e, i, n) {
  ...
  class Yn {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (jn[n.id] = n),
        l && c ? (a.listen(n, 'complete', Bn), a.listen(n, 'progress', Wn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item");
    }
    get aspectRatio() {
      const {
    ...
    _resize(t, e) {
      ...
      (i.width === a.width && i.height === a.height && r === l) ||
        ((i.width = a.width), (i.height = a.height), (i._aspectRatio = i.aspectRatio), be(i, l, !0), i.notifyPlugins('resize', { size: a }), Q(n.onResize, [i, a], i), i.attached && i._doResize() && i.render());
    }
    ensureScalesHaveIDs() {
  ...
  (eo.id = 'bar'),
    (eo.defaults = { datasetElementType: !1, dataElementType: 'bar', categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: 'number', properties: ['x', 'y', 'base', 'width', 'height'] } } }),
    (eo.overrides = { interaction: { mode: 'index' }, scales: { _index_: { type: 'category', offset: !0, grid: { offset: !0 } }, _value_: { type: 'linear', beginAtZero: !0 } } });
  class io extends Ai {
    initialize() {
  ...
  (io.id = 'bubble'),
    (io.defaults = { datasetElementType: !1, dataElementType: 'point', animations: { numbers: { type: 'number', properties: ['x', 'y', 'borderWidth', 'radius'] } } }),
  ...
  (ro.id = 'radar'),
    (ro.defaults = { datasetElementType: 'line', dataElementType: 'point', indexAxis: 'r', showLine: !0, elements: { line: { fill: 'start' } } }),
    (ro.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } });
  class lo extends oo {}
  (lo.id = 'scatter'),
    (lo.defaults = { showLine: !1, fill: !1 }),
    (lo.overrides = { interaction: { mode: 'point' }, plugins: { tooltip: { callbacks: { title: () => '', label: (t) => '(' + t.label + ', ' + t.formattedValue + ')' } } }, scales: { x: { type: 'linear' }, y: { type: 'linear' } } });
      ...
      e.fullCircles &&
        (function (t, e, i) {
          const { x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r } = e,
            ...
            c = e.innerRadius + r;
          let h;
          for (i && ((e.endAngle = e.startAngle + bt), ho(t, e), (e.endAngle = a), e.endAngle === e.startAngle && ((e.endAngle += bt), e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h)
            t.stroke();
  ...
  (vo.id = 'line'),
    (vo.defaults = { borderCapStyle: 'butt', borderDash: [], borderDashOffset: 0, borderJoinStyle: 'miter', borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: 'default', fill: !1, spanGaps: !1, stepped: !1, tension: 0 }),
            ...
            h = (function (t, e, i) {
              ...
              for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                ...
                const m = Math.floor(a * s) + 1,
                  ...
                  { x: b, y: _ } = t[u];
                for (l = c = -1, e = m; e < x; e++) (c = 0.5 * Math.abs((b - i) * (t[e].y - _) - (b - t[e].x) * (n - _))), c > l && ((l = c), (r = t[e]), (h = e));
                (o[d++] = r), (u = h);
              }
        ...
        for (let t = 0; t < n.length; t++) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              ...
              h = bn(r, o, n);
            for (let t = 0; t < h.length; t++) a.push({ source: h[t], target: e, start: { [i]: qo(l, n, 'start', Math.max) }, end: { [i]: qo(l, n, 'end', Math.min) } });
          }
        }
        return a;
      })(i, n, o);
  ...
  var Qo = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      let a, r, l, c;
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)), (l = a.dataset), (c = null), l && l.options && l instanceof vo && (c = { visible: t.isDatasetVisible(r), index: r, fill: zo(l, r, n), chart: t, scale: a.vScale, line: l }), (a.$filler = c), s.push(c);
      ...
      s &&
        ...
        (function (t, e) {
          const { line: i, target: n, above: o, below: s, area: a, scale: r } = e,
            l = i._loop ? 'angle' : 'x';
          t.save(),
            'x' === l && s !== o && (Uo(t, n, a.top), Zo(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), Uo(t, n, a.bottom)),
  ...
  class ts extends Oi {
    ...
    _draw() {
      const t = this,
        ...
        p = g / 2;
      let m;
      t.drawTitle(), (a.textAlign = h.textAlign('left')), (a.textBaseline = 'middle'), (a.lineWidth = 0.5), (a.strokeStyle = u), (a.fillStyle = u), (a.font = d.string);
      ...
      t.legendItems.forEach((e, u) => {
        ...
        h.setWidth(t.width),
          y
            ...
            : u > 0 && D + M > t.bottom && ((P = m.x = P + i[m.line].width + f), m.line++, (D = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
        !(function (t, e, i) {
  ...
  class ps extends Oi {
    ...
    drawTitle(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = us(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = 'middle', a = Ee(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l)
    ...
    drawBody(t, e, i) {
      ...
      let m, x, b, _, y, v, M;
      for (
        e.textAlign = a, e.textBaseline = 'middle', e.font = h.string, t.x = us(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && 'right' !== p ? ('center' === a ? c / 2 + 1 : c + 2) : 0, _ = 0, v = o.length;
        _ < v;
        ++_
      ) {
    ...
    drawFooter(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = us(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = 'middle', a = Ee(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r)
    ...
    buildTicks() {
      const t = this,
        ...
        i = (function (t, e) {
          ...
          do {
            o.push({ value: s, major: Ms(s) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (s = Math.round(r * Math.pow(10, a) * l) / l);
          } while (a < i || (a === i && r < n));
          const c = q(t.max, s);
            ...
            if (0 !== i) {
              ...
              !(function (t, e, i, n) {
                ...
                (!s && !n) ||
                  ...
                  !r ||
                  i < 0 ||
                  (o.save(), (o.strokeStyle = a), (o.lineWidth = r), o.setLineDash(e.borderDash), (o.lineDashOffset = e.borderDashOffset), o.beginPath(), Cs(t, i, s, n), o.closePath(), o.stroke(), o.restore());
              })(t, n, r, s);
            }
          }),
        n.display)
  ...
  class Vs extends ji {
    ...
    initOffsets(t) {
      ...
      e.options.offset &&
        t.length &&
        ((i = e.getDecimalForValue(t[0])), (o = 1 === t.length ? 1 - i : (e.getDecimalForValue(t[1]) - i) / 2), (n = e.getDecimalForValue(t[t.length - 1])), (s = 1 === t.length ? n : (n - e.getDecimalForValue(t[t.length - 2])) / 2));
