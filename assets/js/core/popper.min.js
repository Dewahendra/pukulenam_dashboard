...
!(function (e, t) {
  ...
  function t(e, t) {
    return { width: (e = e.getBoundingClientRect()).width / 1, height: e.height / 1, top: e.top / 1, right: e.right / 1, bottom: e.bottom / 1, left: e.left / 1, x: e.left / 1, y: e.top / 1 };
  }
  function n(e) {
  ...
  function u(e, r, a) {
    ...
    var d = { scrollLeft: 0, scrollTop: 0 },
      m = { x: 0, y: 0 };
    return (
      (c || (!c && !a)) && (('body' !== s(r) || l(u)) && (d = r !== n(r) && i(r) ? { scrollLeft: r.scrollLeft, scrollTop: r.scrollTop } : o(r)), i(r) ? (((m = t(r)).x += r.clientLeft), (m.y += r.clientTop)) : u && (m.x = p(u))),
  ...
  function T(e) {
    ...
    return function (e, t, i) {
      ...
      void 0 === i && (i = o);
      var s = { placement: 'bottom', orderedModifiers: [], options: Object.assign({}, X, o), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
        f = [],
        p = !1,
        c = {
          state: s,
  ...
  function R(e) {
    ...
    return (
      ...
      l
        ? Object.assign({}, o, (((h = {})[g] = s ? '0' : ''), (h[v] = m ? '0' : ''), (h.transform = 1 >= (y.devicePixelRatio || 1) ? 'translate(' + e + 'px, ' + d + 'px)' : 'translate3d(' + e + 'px, ' + d + 'px, 0)'), h))
    ...
    Q = {
      ...
      fn: function (e) {
        ...
        (o = void 0 === o || o),
          ...
          null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign({}, t.styles.popper, R(Object.assign({}, e, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: o, roundOffsets: n })))),
          null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, R(Object.assign({}, e, { offsets: t.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: n })))),
